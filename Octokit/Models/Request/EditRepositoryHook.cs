        ...
        internal string DebuggerDisplay
        {
            get
            {
                return string.Format(CultureInfo.InvariantCulture,
                    "Repository Hook: Replacing Events: {0}, Adding Events: {1}, Removing Events: {2}", Events == null ? "no" : Events.Join(", "),
                    AddEvents == null ? "no" : AddEvents.Join(", "),
                    RemoveEvents == null ? "no" : RemoveEvents.Join(", "));
            }
        }
    }
}