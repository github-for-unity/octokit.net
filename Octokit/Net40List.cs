...
namespace System.Collections.Generic
{
    ...
    [Serializable]
    public class Net40List<T> : IList<T>, System.Collections.IList, IReadOnlyList<T>
    {
        ...
        // given collection.
        // 
        public Net40List(IEnumerable<T> collection)
        {
            if (collection == null)
    ...
    public class ReadOnlyDictionary<TKey, TValue> : Dictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
    {
        public ReadOnlyDictionary(): base() { }

        public ReadOnlyDictionary(int capacity): base(capacity) { }

        public ReadOnlyDictionary(IEqualityComparer<TKey> comparer): base(comparer) { }

        public ReadOnlyDictionary(int capacity, IEqualityComparer<TKey> comparer) : base(capacity, comparer) { }
    ...
    public static class ListExtensions
    {
        ...
        {
            return new Net40List<T>(values);
        }

        public static IReadOnlyDictionary<TKey,TValue> ToReadOnlyDictionary<TKey, TValue>(this Dictionary<TKey, TValue> dict)
        {
